    ...
    private = list(
        .run = function() {
            ...
            if (is.factor(var) && numberUniqueValues == 2) {
                advice <- "You have entered a dichotomous variable. The Binomial test for the population proportion may be a good option for you!
                ...
                advice <- "You have entered a variable of ordinal measurement level.
                ...
                advice <- "You have entered a variable of nominal measurement level.
                ...
                advice <- "You have entered a numeric variable.
