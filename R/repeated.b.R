            ...
            if (length(namesVariables) == 2) {
                if ((measurementLevel[1] == "nominal" || measurementLevel[1] == "ordinal") && numberUniqueValues == 2) {
                    advice <- "You have entered two related dichotomous variables. Hence , 
                               <a href= 'https://statkat.com/stattest.php?&t=39&ref=jam' target='_blank'>McNemar's test</a>
                    ...
                    advice <- "You have entered two related ordinal variables. Hence,  the
                               <a href= 'https://statkat.com/stattest.php?&t=34&ref=jam' target='_blank'>sign test</a>
                                 seems to be a good option for you! jamovi does not have a specific option for the sign test.
                                However, you can use the <a href= 'https://statkat.com/stattest.php?&t=33&ref=jam' target='_blank'>Friedman test</a> instead. The <i>p</i> value resulting from this Friedman test
                    ...
                    advice <- "You have entered two related nominal variables. Hence, the
                               <a href= 'https://statkat.com/stattest.php?&t=41&ref=jam' target='_blank'>marginal homogeneity test</a>
                    ...
                    advice <- "You have entered two related numeric variables. Hence, the
                               <a href= 'https://statkat.com/stattest.php?&t=7&ref=jam' target='_blank'>paired sample <i>t</i> test</a>
                                 seems to be a good option for you! In order to run this test in jamovi, go to:
                                <br><br>
                               T-Tests > Paired Samples T-Test
                                ...
                                <a href= 'https://statkat.com/stattest.php?&t=35&ref=jam' target='_blank'>Wilcoxon signed rank test</a>.
                ...
                if ((measurementLevel[1] == "nominal" || measurementLevel[1] == "ordinal") && numberUniqueValues == 2) {
                    advice <- "You have entered several related dichotomous variables. Hence, 
                               <a href= 'https://statkat.com/stattest.php?&t=40&ref=jam' target='_blank'>Cochran's <i>Q</i> test</a>
                    ...
                    advice <- "You have entered several related ordinal variables. Hence, the
                               <a href= 'https://statkat.com/stattest.php?&t=33&ref=jam' target='_blank'>Friedman test</a>
                                seems to be a good option for you! In order to run this test in jamovi, go to:
                                <br><br>
                                ANOVA > Repeated Measures ANOVA - Friedman
                                <ul>
